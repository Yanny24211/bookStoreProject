    ...
    public void logOutSequence(Stage primaryStage, boolean ShutDown) {
        ...
        if (!ShutDown) {
            {/*
                ...
                PauseTransition pause = new PauseTransition(Duration.seconds(1)); // Create a 6-second pause
            ...
            PauseTransition pause = new PauseTransition(Duration.seconds(6)); // Create a 6-second pause
